  ...
  describe("rewrites are behavior-preserving", () => {
    ...
    describe("every well-known registry pattern", () => {
      const SEEDS: Record<string, string[]> = {
        ...
        __zcReIsoDate: ["2020-02-29", "2021-02-29", "1999-12-31", "2000-01-01", "2020-13-01"],
        __zcReIsoDateTime: [
          "2020-01-02T03:04:05Z",
          "2020-02-29T23:59:59.999Z",
          "2020-01-02T03:04:05",
        ],
        __zcReIsoDuration: ["P3Y6M4DT12H30M5S", "PT1H", "P1W", "P"],
        __zcReIsoTime: ["00:00", "23:59:59", "12:34:56.789", "24:00"],
